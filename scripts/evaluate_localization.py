...
async def run() -> int:
    ...
    L += [
        ...
        "   CONFOUND RESOLVED: the flat GNN impaired was DATA-SCARCITY, not a ceiling. Supplementary",  # noqa: E501
        ...
        "   leaf3/leaf4 stays THE headline; CV is a labeled supplement (gate12_5-localization-cv.txt).",  # noqa: E501
